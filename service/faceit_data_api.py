...
class FaceitData:
    ...
    def get_player_elo(self, player_id):
        if player_id in self.player_elos: return self.player_elos[player_id]

        player_details = self.player_id_details(player_id=player_id)
        self.player_elos[player_id] = player_details["games"]["csgo"]["faceit_elo"]
